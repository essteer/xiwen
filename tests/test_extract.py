...
from src.xiwen.utils.extract import filter_hanzi, filter_text
...
class TestFilterHanzi(unittest.TestCase):
    def test_character_filter(self):
        ...
        self.assertEqual([filter_hanzi(zi) for zi in hanzi], [True for _ in hanzi])
    ...
    def test_non_hanzi_filter(self):
        ...
        self.assertEqual(
            [filter_hanzi(zi) for zi in hanzi],
